...
- Upgrade chart to version [6.0.3](https://github.com/grafana/mimir/blob/main/operations/helm/charts/mimir-distributed/CHANGELOG.md#600)
- Upgrade mimir to [3.0.0](https://github.com/grafana/mimir/blob/main/CHANGELOG.md#300)
